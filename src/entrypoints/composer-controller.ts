...
const THINKING_OPTION_ICONS: Record<ThinkingLevel, string> = {
    light: `
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path d="M10.0007 2.08496C14.3719 2.08496 17.9157 5.62867 17.9157 10C17.9157 14.3713 14.3719 17.915 10.0007 17.915C5.62939 17.915 2.08569 14.3713 2.08569 10C2.08569 5.62867 5.62939 2.08496 10.0007 2.08496ZM10.0007 8.5C8.50073 8.5 5.00073 9.5 5.00073 10C5.00073 10.5 8.50073 11.5 10.0007 11.5C11.5007 11.5 15.0007 10.5 15.0007 10C15.0007 9.5 11.5007 8.5 10.0007 8.5ZM10.0007 3.41504C6.3632 3.41504 3.41504 6.3632 3.41504 10C3.41504 13.6368 6.3632 16.585 10.0007 16.585C13.6375 16.585 16.5857 13.6368 16.5857 10C16.5857 6.3632 13.6375 3.41504 10.0007 3.41504Z"></path>
        </svg>`,
    standard: `
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path d="M10.0007 2.08496C14.3719 2.08496 17.9157 5.62867 17.9157 10C17.9157 14.3713 14.3719 17.915 10.0007 17.915C5.62939 17.915 2.08569 14.3713 2.08569 10C2.08569 5.62867 5.62939 2.08496 10.0007 2.08496ZM10.0007 8.5C8.50073 8.5 5.00073 9.5 5.00073 10C5.00073 10.5 8.50073 11.5 10.0007 11.5C11.5007 11.5 15.0007 10.5 15.0007 10C15.0007 9.5 11.5007 8.5 10.0007 8.5Z"></path>
        </svg>`,
    extended: `
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path d="M10.0007 2.08496C14.3712 2.08496 17.915 5.62852 17.915 9.99996C17.915 14.3714 14.3712 17.915 10.0007 17.915C5.6292 17.915 2.08564 14.3714 2.08564 9.99996C2.08564 5.62852 5.6292 2.08496 10.0007 2.08496ZM10.0007 3.41505C6.36323 3.41505 3.41507 6.36321 3.41507 9.99969C3.41507 13.6362 6.36323 16.5844 10.0007 16.5844C13.6381 16.5844 16.5863 13.6362 16.5863 9.99969C16.5863 6.36321 13.6381 3.41505 10.0007 3.41505Z"></path>
        </svg>`,
    heavy: `
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
